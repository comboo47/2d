...
@export var moveComponent:BBNode
var _waypoint: Vector2
var mvComponent:MoveComponent
...
func _enter() -> void:
	...
	mvComponent = moveComponent.get_value(agent,blackboard,null)
...
func _tick(_delta: float) -> Status:
	...
	var desired_velocity: Vector2 = agent.global_position.direction_to(_waypoint)
	print(target,":",desired_velocity,",",_waypoint)
	mvComponent.moveToDirection(desired_velocity.normalized())
